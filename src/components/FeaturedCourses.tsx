...
function FeaturedCourses() {
  ...
  return (
    <div className="dark:bg-grid-white/[0.2] pt-10 pb-10">
        <div >
        ...
        <div className="mt-10 mx-8 font-bold bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400">
                    ...
                    <div key={course.id} className="flex justify-center">
                        ...
                        className="flex flex-col rounded-[22px] bg-white dark:bg-zinc-900 overflow-hidden h-full max-w-sm">
                            <div className="p-4 sm:p-6 flex flex-col items-center text-center flex-grow">
                                ...
                                <Link href={`/courses/${course.slug}`} className="text-white mt-5 dark:bg-blue-900 p-3 rounded-full shadow-white shadow-sm">
                                View Courses
                                </Link>
                            </div>
                        </BackgroundGradient>
